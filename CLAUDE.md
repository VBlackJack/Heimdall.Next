...
**Current build**: v2026.032608 (Release)
...
locales/                 # en.json, fr.json (~4,290 keys each)
```
...
- `InputValidator` centralized security: `EscapeShellArg()`, `EscapeForDoubleQuotedString()`, `ValidateDomain()`, `SanitizeCsvCell()`
