...
public sealed class ToolRegistry
{
    ...
    public ToolRegistry()
    {
        var entries = new List<ToolEntry>
        {
            ...
            Entry("ARPMON",   ToolCategory.Network,  "ToolCategoryNetwork",  "PaletteToolArp",      null,                      ["arp","arpmon"],                false, () => new Views.Tools.ArpMonitorView(),         "Geo.Tool.ArpMonitor"),
            Entry("FWTEST",   ToolCategory.Network,  "ToolCategoryNetwork",  "PaletteToolFwTest",   null,                      ["fw","firewall","fwtest"],      false, () => new Views.Tools.FirewallTesterView(),     "Geo.Tool.FirewallTester"),
            ...
            Entry("PWDAUDIT", ToolCategory.Security, "ToolCategorySecurity", "PaletteToolPwdAudit", null,                      ["pwdaudit","password-audit","passcheck"], false, () => new Views.Tools.PasswordAuditView(), "Geo.Tool.PasswordAudit"),
            Entry("SSHAUDIT",ToolCategory.Security, "ToolCategorySecurity", "PaletteToolSshAudit", null,                      ["sshaudit","keyaudit"],          false, () => new Views.Tools.SshKeyAuditView(),        "Geo.Tool.SshKeyAudit"),
            ...
            Entry("SECNUMCLOUD",ToolCategory.Security, "ToolCategorySecurity", "PaletteToolAudit",  null,                      ["secnumcloud","audit","compliance","anssi"], false, () => new Views.Tools.SecNumCloudAuditView(), "Geo.Tool.SecNumCloud"),
