...
/// <summary>
/// Thin WPF shell for the route table tool.
/// </summary>
public partial class RouteTableView : UserControl, IToolView
{
    private readonly RouteTableViewModel _vm;
    private LocalizationManager? _localizer;
    private bool _disposed;

    public RouteTableView()
    {
        _vm = new RouteTableViewModel();
        InitializeComponent();
        DataContext = _vm;
    ...
    {
        AutomationProperties.SetName(BtnRefresh, L("ToolRouteTableBtnRefresh"));
        AutomationProperties.SetName(BtnCopy, L("ToolBtnCopyToClipboard"));
        AutomationProperties.SetName(RoutesGrid, L("ToolRouteTableTitle"));
    ...
    {
        if (e.PropertyName is nameof(RouteTableViewModel.StatusText))
        {
